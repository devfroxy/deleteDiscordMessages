    ...
    <div class="toolbar" style="position:fixed;top:0;left:0;right:0;padding:8px;background:#36393f;box-shadow: 0 1px 0 rgba(0,0,0,.2), 0 1.5px 0 rgba(0,0,0,.05), 0 2px 0 rgba(0,0,0,.05);">
        <div style="display:flex;flex-wrap:wrap;">
            ...
            <span>DM/Kanal <a href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/channelId.md" title="Help">?</a>
                ...
                <label for="file"  title="Import list of channels from messages/index.json file"> Yükle: <span class="btn">...</span> <input id="file" type="file" accept="application/json,.json"></label>
            </span><br>
            <span>Aylar <a href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/messageId.md" title="Help">?</a><br>
                ...
                <input id="minId" type="text" placeholder="Mesajdan sonraki ID" priv><br>
        ...
        <hr>
        <button id="start" style="background:#43b581;width:80px;">Başlat</button>
