...
// @namespace     https://github.com/devfroxy/deleteDiscordMessages
// @version       4.1
// @match         https://discord.com/*
// @downloadURL   https://raw.githubusercontent.com/devfroxy/deleteDiscordMessages/master/deleteDiscordMessages.user.js
// @homepageURL   https://github.com/devfroxy/deleteDiscordMessages
// @supportURL    https://github.com/devfroxy/deleteDiscordMessages/issues
 ...
 * @author devfroxy <https://www.github.com/devfroxy>
 * @see https://github.com/devfroxy/deleteDiscordMessages
 */
    ...
    <div id="undiscord" style="display:none;">
        ...
        <div class="form">
            <div style="display:flex;flex-wrap:wrap;">
                <span>Authorization <a
                        href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/authToken.md" title="Help"
                        target="_blank">?</a> <button id="getToken">get</button><br>
                    <input type="password" id="authToken" placeholder="Auth Token" autofocus>*<br>
                    <span>Author <a href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/authorId.md"
                ...
                <span>Guild/Channel <a
                        href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/channelId.md" title="Help"
                        target="_blank">?</a>
                ...
                <span>Range <a href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/messageId.md"
                ...
                <span>Search messages <a
                        href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/filters.md" title="Help"
                        target="_blank">?</a><br>
                ...
                <span>Search Delay <a
                href="https://github.com/devfroxy/deleteDiscordMessages/blob/master/help/delay.md" title="Help"
                target="_blank">?</a><br>
        ...
        <pre class="logarea">
            <center>Star this project on <a href="https://github.com/devfroxy/deleteDiscordMessages" target="_blank">github.com/devfroxy/deleteDiscordMessages</a>!\n\n
                <a href="https://github.com/devfroxy/deleteDiscordMessages/issues" target="_blank">Issues or help</a>
            </center>
        </pre>
    </div>
    `);
